...
const OnboardingScreen = () => {
              ...
              style={{
                ...
                backgroundColor:
                  index == currentSlideIndex
                    ? onBoardingColor.indicator_color
                    : '#adaaaa',
                borderRadius: 15,
                marginHorizontal: 10,
              }}></View>
    ...
    return (
      <View style={styles.footer2_top_box}>
        {currentSlideIndex != onboardingdata.length - 1 ? (
          <>
            <TouchableOpacity style={styles.skip_btn_style} onPress={skipPress}>
              <Text style={styles.skip_btn_txt_style}>
                {t('onboarding.skip')}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text style={styles.next_btn_txt_style}>
                {t('onboarding.next')}
              </Text>
            </TouchableOpacity>
          </>
  ...
  return (
    <View>
      <ImageBackground
        source={require('../../Images/onboarding_bg.png')}
      ...
      <FlatList
        ...
        contentContainerStyle={{height: windowHeight * 0.8}}
