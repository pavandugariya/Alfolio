                            ...
                            return (
                                <View key={index}  >
                                    ...
                                    <View style={styles.top_conatiner}>
                                        ...
                                        <Text style={styles.school_style}>High Secondary School</Text>
                                        <Text style={styles.board_style}>MP BOARD</Text>
                                        <View style={styles.top_inner_container}>
                                            <View style={{ flexDirection: 'row', alignItems: 'baseline' }}>
                                                <Text style={styles.bottom_text_style}>Download </Text>
                                                <Icon name={'checkmark-circle'} color={globalcolors.icon_color} size={10} />
                                            </View>
                                            <View style={{ flexDirection: 'row', alignItems: 'baseline' }}>
